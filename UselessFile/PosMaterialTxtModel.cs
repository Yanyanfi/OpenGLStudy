...
internal class PosMaterialTxtModel : TxtModel
{
    ...
    public PosMaterialTxtModel(
        string verticesFilePath,
        string IndicesFilePath,
        Vector3 ambient,
        Vector3 diffuse,
        Vector3 specular,
        float shininess
    )
        : base(verticesFilePath, IndicesFilePath) 
    {
